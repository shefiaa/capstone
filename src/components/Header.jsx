...
function Header() {
  ...
  return (
    ...
    <header className='flex justify-between dark:text-white items-center'>
      ...
      <div className='flex space-x-4 items-center md:space-x-6'>
        <button
          ...
          className='hidden md:block button mr-4'>
          + Add New task
        </button>

        {/* Add Sign Up/Register Button */}
        <button
    ...
    {boardModalOpen && (
      <AddEditBoardModal type={boadType} setBoardModalOpen={setBoardModalOpen} />
    )}
    ...
    {showLogin && (
      <div className='overlay'>
        <div className='modal'>
          <button onClick={() => setShowLogin(false)} className='button'>
            Close
          </button>
          <Login />
        </div>
